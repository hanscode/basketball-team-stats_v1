def display_team_stats(team_name, team_players):
    ...
    Args:
        ...
        team_players (list of dict): A list of player dictionaries
...
def main_menu(balanced_teams):
    ...
    Provides options to display team statistics or quit the program.
    If 'Display Team Stats' is selected, prompts the user to choose a team
    and displays relevant statistics.

    Args:
        balanced_teams (dict): A dictionary of teams with lists of player
            dictionaries.
